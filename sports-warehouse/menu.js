...
const menuToggle = document.querySelector(".top-nav-toggle");
...
function toggleMenu() {
  ...
  if (menuToggle && menu) {
    ...
    if (menu.classList.contains("active")) {
      ...
      menuToggle.querySelector("a").innerHTML = ' <div class="pre-icon"><span class="sr-only">Open Menu</span><i class="fas fa-bars fa-lg" aria-label="Open Menu"></i></div><p>Menu</p>';
    ...
    // otherwise open it
      ...
      menuToggle.querySelector("a").innerHTML = '<span class="sr-only">Menu Close</span><i class="fas fa-times fa-lg" aria-label="Close Menu"></i>';
